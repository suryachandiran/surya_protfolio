...
function App() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_o3z2n59", "template_8zt2h0p", form.current, {
        publicKey: "rtKGgFwG7wj2jwifY",
      })
      .then(
        () => {
